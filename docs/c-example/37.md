...
在下面的程序中，我们有三个整数`num1`，`num2`＆amp; `num3`。我们已将这三个数字的地址分配给三个指针`p1`，`p2`＆amp; `p3`分别。之后我们使用 [if else 语句](https://beginnersbook.com/2014/01/c-if-statement/)对存储在指针指向的地址处的值进行了比较。
