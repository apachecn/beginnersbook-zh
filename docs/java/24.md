...
**方法重载**是[静态多态性](https://beginnersbook.com/2013/04/runtime-compile-time-polymorphism/)的一个例子。我们将在单独的教程中讨论[多态性](https://beginnersbook.com/2013/03/polymorphism-in-java/)及其类型。
